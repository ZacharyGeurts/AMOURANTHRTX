...
// NAMESPACE HELL = DEAD — GLOBAL SPACE = GOD — VulkanRTX MOVED TO GLOBAL
// FORWARD DECLARE ONLY — NO NAMESPACE WRAPPING — TALK TO ME DIRECTLY
...
// FORWARD DECLARATIONS — NO CIRCULAR — NO NAMESPACE
class Application;
class VulkanRenderer;
class VulkanRTX;  // NOW GLOBAL — NO NAMESPACE CONFLICT

// CAMERA INTERFACE — GLOBAL SPACE
class Camera {
public:
...
// PERSPECTIVE CAMERA — GLOBAL SPACE — NO NAMESPACE
...
// NO NAMESPACE — GLOBAL SPACE = SUPREME
// VulkanRTX class lives in global — no conflict
// OLD: namespace VulkanRTX { class VulkanRenderer; } → REMOVED