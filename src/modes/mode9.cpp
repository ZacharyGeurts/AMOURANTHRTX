// mode9.cpp
// Implementation of renderMode9 for AMOURANTH RTX Engine to draw nine moving mirror balls.
...
void renderMode9(const UE::AMOURANTH* amouranth, [[maybe_unused]] uint32_t imageIndex, VkBuffer vertexBuffer, VkCommandBuffer commandBuffer,
    ...
    for (int i = 0; i < 9; ++i) {
        ...
        pushConstants.color = (i == 0) ? glm::vec4(0.8f, 0.8f, 0.8f, 1.0f) :
                             ...
                             (i == 7) ? glm::vec4(1.0f, 0.3f, 0.3f, 1.0f) :
                                        glm::vec4(0.3f, 0.9f, 0.9f, 1.0f); // Cyan
