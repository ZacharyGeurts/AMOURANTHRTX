...
// =============================================================================
// RENDERMODE 6 — ALPHA TEST VISUALIZER — RED = ALPHA-CLIPPED
...
{
    LOG_SUCCESS_CAT("RTX", "MODE 6 — ALPHA TEST VISUALIZER — RED = ALPHA-CLIPPED");
}
...
void RenderMode6::updateUniforms(float)
{
    ...
    // NOW SAFE — assign after creation
...
void RenderMode6::renderFrame(VkCommandBuffer cmd, float dt)
{
    updateUniforms(dt);
    traceRays(cmd);
