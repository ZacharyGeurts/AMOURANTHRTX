// mode7.cpp
// Implementation of renderMode7 for AMOURANTH RTX Engine to draw seven moving mirror balls.
...
void renderMode7(const UE::AMOURANTH* amouranth, [[maybe_unused]] uint32_t imageIndex, VkBuffer vertexBuffer, VkCommandBuffer commandBuffer,
