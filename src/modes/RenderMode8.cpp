...
// =============================================================================
// RenderMode8.cpp — VALHALLA v45 FINAL — NOV 12 2025
// • Ray tracing dispatch with lazy accumulation
// • Hybrid raster-ray for mode 8
...
RenderMode8::RenderMode8(VulkanRTX& rtx, uint32_t width, uint32_t height)
    ...
    initResources();
    LOG_INFO_CAT("RenderMode8", "{}Mode 8 Initialized — {}×{} — Hybrid Raster-Ray Tracing{}", ELECTRIC_BLUE, width, height, RESET);
}
...
RenderMode8::~RenderMode8() {
    ...
    LOG_DEBUG_CAT("RenderMode8", "Mode 8 Resources Released");
}
