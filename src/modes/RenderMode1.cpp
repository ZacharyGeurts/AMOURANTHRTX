...
// =============================================================================
// RenderMode1.cpp — VALHALLA v45 FINAL — NOV 12 2025
// • Ray tracing dispatch with lazy accumulation
// • Direct + 1-bounce for mode 1
...
RenderMode1::RenderMode1(VulkanRTX& rtx, uint32_t width, uint32_t height)
    ...
    initResources();
    LOG_INFO_CAT("RenderMode1", "{}Mode 1 Initialized — {}×{} — Basic Path Tracing{}", ELECTRIC_BLUE, width, height, RESET);
}
...
RenderMode1::~RenderMode1() {
    ...
    LOG_DEBUG_CAT("RenderMode1", "Mode 1 Resources Released");
}
