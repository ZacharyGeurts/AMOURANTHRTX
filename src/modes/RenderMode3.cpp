...
// FULLY MODULAR. THREE SPHERES. 3 BOUNCES. ENV LIT.
...
#define LOG_MODE3(...) LOG_DEBUG_CAT("RenderMode3", __VA_ARGS__)
...
void renderMode3(
    ...
    LOG_MODE3("{}MULTI-SPHERE | {}x{} | zoom: {:.2f} | RGB spheres + env{}", 
    ...
    push.samplesPerPixel = 8;  // MODE 3: 8 SPP
    push.maxDepth        = 3;  // MODE 3: 3 bounces
    push.maxBounces      = 3;
    ...
    LOG_MODE3("{}DISPATCHED | 8 spp | 3 bounces | RGB spheres{}", Logging::Color::EMERALD_GREEN, Logging::Color::RESET);
}
