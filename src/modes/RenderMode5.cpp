...
// FULLY MODULAR. SPHERES + VOLUME. 4 BOUNCES. MIST EFFECT.
...
#define LOG_MODE5(...) LOG_DEBUG_CAT("RenderMode5", __VA_ARGS__)
...
void renderMode5(
    ...
    LOG_MODE5("{}VOLUMETRIC FOG | {}x{} | zoom: {:.2f} | spheres + mist{}", 
    ...
    push.samplesPerPixel = 12;  // MODE 5: 12 SPP
    push.maxDepth        = 4;  // MODE 5: 4 bounces
    push.maxBounces      = 4;
    ...
    LOG_MODE5("{}DISPATCHED | 12 spp | 4 bounces | fog + spheres{}", Logging::Color::EMERALD_GREEN, Logging::Color::RESET);
}
