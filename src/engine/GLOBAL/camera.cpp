...
// FIXED: Forward declare HandleInput to resolve undeclared type
...
class HandleInput;     // FIXED: Forward declare HandleInput
class Camera;          // Forward declare Camera (assuming global)
...
private:
    ...
    std::unique_ptr<HandleInput> inputHandler_;  // FIXED: Now compiles with forward decl
