// source/engine/SDL3/SDL3_window.cpp
// =============================================================================
...
//
// =============================================================================
// SDL3 Window RAII — CPP IMPLEMENTATIONS — NOV 13 2025
// • Respects Options::Performance::ENABLE_IMGUI → resizable + high DPI
// • GLOBAL ACCESS — Vulkan resize routed
...
SDLWindowPtr createWindow(const char* title, int w, int h, Uint32 flags) {
    ...
    if (Options::Performance::ENABLE_IMGUI) {
        ...
        LOG_INFO_CAT("Window", "ImGui enabled — resizable + high DPI flags added");
    }
