...
// FINAL FORM LOADED - DLSS 3.5 + MESH SHADERS + RT + SVGF - ENGINE IS ALIVE
...
VulkanRenderer::VulkanRenderer(Vulkan::Context& context, int width, int height)
    : context_(context), width_(width), height_(height),
      pipelineManager_(std::make_unique<VulkanPipelineManager>(context, width, height)),
      currentFrame_(0), frameIndex_(0),
