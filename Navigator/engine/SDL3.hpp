...
constexpr int     SOFT_MAX_SLOTS       = 32;
...
public:
    ...
    // Smart ESC (first press releases mouse, second quits)
...
private:
    SDL3System() = default;   // Explicit default constructor for singleton
...
inline void SDL3System::bindDefaultActions() {
    ...
    // Gamepad string bindings for Pipeline
